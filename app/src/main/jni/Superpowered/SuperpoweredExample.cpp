...
extern "C" JNIEXPORT void Java_de_beuth_not1fy_app_CrossExampleActivity_onPlayPause(JNIEnv * __unused javaEnvironment, jobject __unused obj, jboolean play) {
	example->onPlayPause(play);
}

extern "C" JNIEXPORT void Java_de_beuth_not1fy_app_CrossExampleActivity_onCrossfader(JNIEnv * __unused javaEnvironment, jobject __unused obj, jint value) {
	example->onCrossfader(value);
}

extern "C" JNIEXPORT void Java_de_beuth_not1fy_app_CrossExampleActivity_onFxSelect(JNIEnv * __unused javaEnvironment, jobject __unused obj, jint value) {
	example->onFxSelect(value);
}

extern "C" JNIEXPORT void Java_de_beuth_not1fy_app_CrossExampleActivity_onFxOff(JNIEnv * __unused javaEnvironment, jobject __unused obj) {
	example->onFxOff();
}

extern "C" JNIEXPORT void Java_de_beuth_not1fy_app_CrossExampleActivity_onFxValue(JNIEnv * __unused javaEnvironment, jobject __unused obj, jint value) {
